Page({
  ...
  onSubmitClick: function(e){
    ...
    if(sckName && sytName && smapDatePlate && sboxesNumber){
      wx.request({
        ...
        url: 'http://192.168.197.1:8888/cf/mi/miSave',
        header: {
  ...
  onLoad: function(options) {
    ...
    wx.request({
      ...
      url: 'http://192.168.197.1:8888/user/getUser/',
      header: {
        'cookie': wx.getStorageSync("sessionid")
      },
      method: 'get',
    ...
    if(id){
      wx.request({
        ...
        url: 'http://192.168.197.1:8888/cf/mi/get/'+ id,
        header: {
          'cookie': wx.getStorageSync("sessionid")
        },
        method: 'get',
  ...
  bindCkPickerChange: function (e) {
    if(e.detail.value == '0'){}else{
      ...
      wx.request({
        ...
        url: 'http://192.168.197.1:8888/cf/pm/page',
        header: {
          'cookie': wx.getStorageSync("sessionid"),
          'content-type': 'application/x-www-form-urlencoded; charset=UTF-8'
        },
        ...
        success: res => {
          ...
          if(yt){
            wx.request({
              ...
              url: 'http://192.168.197.1:8888/cf/mi/getTimeBlock',
              header: {
                'cookie': wx.getStorageSync("sessionid"),
                'content-type': 'application/x-www-form-urlencoded; charset=UTF-8'
              },
